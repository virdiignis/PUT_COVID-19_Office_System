...
urlpatterns = [
    ...
    path('dashboard/reminders', views.ReminderDashboardView.as_view(), name='reminders_dashboard'),
    path('reminders/mark_done/<int:pk>', views.reminder_mark_done, name='reminders_mark_done'),
    path('reminders/delete/<int:pk>', views.reminder_delete, name='reminders_delete'),
