    ...
    $.fn.formset = function (opts) {
        ...
        if ($$.length) {
            ...
            if (options.formTemplate) {
                ...
                let lastForm = $('.' + options.formCssClass + ':last');
                if (options.hideLastAddForm) lastForm.hide();
            ...
            addButton.click(function () {
                ...
                if (options.insert_first) {
                    let first_row = $(".formset_row." + options.prefix).first()
                    row.insertBefore(first_row).show();
                } else {
                    let last_row = $(".formset_row." + options.prefix).last()
                    row.insertAfter(last_row).show();
                }
                ...
                if (options.prefix === "isolations") {
                    $('[id ^=id_isolations-][id $=-person]').last().on("select2:select", (e) => {
